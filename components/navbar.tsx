...
//     return (
//         <nav className="fixed top-0 left-0 w-full h-[60px] z-50 bg-slate-200 flex items-center justify-between px-4 text-slate-900">
//             <div className="flex gap-4 h-6 items-center">
//                 <SidebarTrigger />
//                 <Separator
//                     orientation="vertical"
//                     className="w-[1.5px] rounded-full bg-slate-500"
//                 />
//                 <Link
//                     href={"/"}
